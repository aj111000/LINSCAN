...
int main() {
    double x[11] = {2, 4,  0.92064502,  0.24332643,  0.25388742,
        1.45467181, -1.3941616 ,  5.27492206,  1.13397695, -0.41081394,
        2.25968006};

    double y[11] = {4 ,   6,   0.04480065,   0.17672284,
         0.96730425,  79.91013646, -14.59928098,   3.70103455,
         8.82134985,  -1.4470395 ,   1.26771892};
